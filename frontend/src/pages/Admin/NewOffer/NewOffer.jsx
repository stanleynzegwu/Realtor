...
const NewOffer = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if(!title || !desc || !category || !imagesFile.length || !startDate
          || !endDate) {
        ...
        <div className="newOffer">
            <div className="newOffer_Left">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="newOffer_leftFormItem">
                        <label>Desc</label>
                        <div className='newOffer_leftFormItemGroup' style={{border: isGenerateTextSuccess && '2px solid #3eff3e'}}>
                            <textarea 
                                ...
                                ref={descRef}
                            />
                            <button disabled={isGenerateTextLoading} onClick={ handleSubmitText } className='aiEdit_btn'>AI Edit</button>
                        </div>
                    ...
                    <div className="newOffer_leftFormItem">
                        <label htmlFor="file" className='label_imgUpload'>Upload Image</label>
                    ...
                    <button disabled={ isLoading } className='newOffer_leftFormItemBtn'>Send</button>
                    {error
                      &&
                      errorMessageDisplay
                      &&
            ...
            <div className="newOffer_Right">
                ...
                <div className="newOfferRight_item">
                    ...
                    <p className="newOfferRight_item newOffer_validDate">
                        Offer starts <span className='startDate'>{formData.startDate}</span> and 
                        ends <span className='endDate'>{formData.endDate}</span>
                    </p>
                </div>
            </div>
        </div>
