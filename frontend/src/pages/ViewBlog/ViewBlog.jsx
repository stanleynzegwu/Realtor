          ...
          <div className="singleBlogWrapper">
            <div className="singleBlog">
              ...
              <span className="singleBlog__date">
                {formatDistanceToNow(new Date(singleBlog.createdAt), { addSuffix: true })}
              </span>
