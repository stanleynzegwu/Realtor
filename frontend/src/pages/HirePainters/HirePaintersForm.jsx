    ...
    <div className="hirePainters">
      <div className="hire_wrapper">
        <div className="hire_left">
          ...
          <form onSubmit={handleSubmit}>
            <div className="form_field">
              <label>
                Address of Property <span className="reqOrOpt">(required)</span>
              </label>
              <input
            ...
            <div className="form_field">
              <label>
                Size of Property (square footage) <span className="reqOrOpt">(required)</span>
              </label>
              <input
            ...
            <div className="form_field">
              <label>
                Preffered Start Date <span className="reqOrOpt">(optional)</span>
              </label>
              <input
            ...
            <div className="form_field">
              <label>
                Preffered Completion Date <span className="reqOrOpt">(optional)</span>
              </label>
              <input
            ...
            <div className="form_field">
              <label>
                Type of Paint Desired <span className="reqOrOpt">(optional)</span>
              </label>
              <input
            ...
            <div className="form_field">
              <label>
                Budget <span className="reqOrOpt">(required)</span>
              </label>
              <input
            ...
            <div className="form_field">
              <label>
                Special Request <span className="reqOrOpt">(optional)</span>
              </label>
              <input
            ...
            <div className="form_field">
              <label>
                Full Name <span className="reqOrOpt">(required)</span>
              </label>
              <input
            ...
            <div className="form_field">
              <label>
                Email <span className="reqOrOpt">(required)</span>
              </label>
              <input
            ...
            <div className="form_field">
              <label>
                Phone Number <span className="reqOrOpt">(required)</span>
              </label>
              <input
        ...
        <div className="hire_right">
          ...
          <p className="hire_sub-text">
            A dash of the masterful brushstroke from our skilled painter will imbue your structure
            with a radiant gleam, transforming it into a visually stunning masterpiece that will
            leave a lasting impression on everyone who sees it.
            <br />
            <br />
            Our painter's expertise in color theory, composition, and technique will elevate the
            look and feel of your building, making it stand out in a sea of bland, unremarkable
            structures.
            <br />
            <br />
            Whether you're looking to revamp a tired facade or simply add a touch of flair, our
            painter has the skills and vision to bring your vision to life.
          </p>
